...
@Component({
  selector: "app-list-universiteF",
  templateUrl: "./list-universiteF.component.html",
  styleUrls: ["./list-universiteF.component.scss"],
})
export class ListUniversiteFComponent {
  universities: any;
  searchTerm: string = "";
  logs: string[] = [];
